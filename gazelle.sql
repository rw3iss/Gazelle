...
CREATE TABLE `collages_artists` (
  ...
  `AddedOn` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `comments` (
  ...
  `AddedTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `Body` mediumtext,
...
CREATE TABLE `featured_albums` (
  ...
  `Started` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `Ended` datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
) ENGINE=InnoDB CHARSET utf8;
...
CREATE TABLE `forums` (
  ...
  `LastPostTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `forums_polls` (
  ...
  `Featured` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `forums_topics` (
  ...
  `CreatedTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  PRIMARY KEY (`ID`),
  KEY `AuthorID` (`AuthorID`),
  KEY `ForumID` (`ForumID`),
...
CREATE TABLE `login_attempts` (
  ...
  `LastAttempt` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `Attempts` int(10) unsigned NOT NULL,
  `BannedUntil` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `pm_conversations_users` (
  ...
  `ReceivedDate` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `reports` (
  ...
  `ResolvedTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `ReportedTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `reportsv2` (
  ...
  `Status` enum('New','InProgress','Resolved') DEFAULT 'New',
  `ReportedTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `LastChangeTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `ModComment` text,
  `Track` text,
  `Image` text,
  `ExtraID` text,
...
CREATE TABLE `requests` (
  ...
  `TorrentID` int(10) unsigned NOT NULL DEFAULT '0',
  `TimeFilled` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `torrents_bad_files` (
  ...
  `TimeAdded` datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
) ENGINE=InnoDB CHARSET utf8;
...
CREATE TABLE `users_history_ips` (
  `UserID` int(10) NOT NULL,
  `IP` varchar(15) NOT NULL DEFAULT '0.0.0.0',
  `StartTime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
CREATE TABLE `users_info` (
  ...
  `AuthKey` varchar(32),
  `ResetKey` varchar(32),
  `ResetExpires` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  ...
  `RatioWatchEnds` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `RatioWatchDownload` bigint(20) unsigned NOT NULL DEFAULT '0',
  `RatioWatchTimes` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `BanDate` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
INSERT INTO forums (ID, CategoryID, Sort, Name, Description, MinClassRead, MinClassWrite, MinClassCreate, NumTopics, NumPosts, LastPostID, LastPostAuthorID, LastPostTopicID, LastPostTime) VALUES (1, 1, 20, 'Your Site', 'Totally rad forum', 100, 100, 100, 0, 0, 0, 0, 0, '1000-01-01 00:00:00'), (2, 5, 30, 'Chat', 'Expect this to fill up with spam', 100, 100, 100, 0, 0, 0, 0, 0, '1000-01-01 00:00:00'), (3, 10, 40, 'Help!', 'I fell down and I cant get up', 100, 100, 100, 0, 0, 0, 0, 0, '1000-01-01 00:00:00'), (4, 20, 100, 'Trash', 'Every thread ends up here eventually', 100, 500, 500, 0, 0, 0, 0, 0, '1000-01-01 00:00:00');

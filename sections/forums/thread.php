...
?>
	<div class="box thin clear">
		<div class="head colhead_dark"><strong>Poll<? if ($Closed) { echo ' [Closed]'; } ?><? if ($Featured && $Featured !== '1000-01-01 00:00:00') { echo ' [Featured]'; } ?></strong> <a href="#" onclick="$('#threadpoll').gtoggle(); log_hit(); return false;" class="brackets">View</a></div>
...
<?	}
	if (check_perms('forums_polls_moderate') && !$RevealVoters) {
		if (!$Featured || $Featured == '1000-01-01 00:00:00') {
?>
